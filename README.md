...
[![install size][badge-install-size]](https://packagephobia.now.sh/result?p=reference-repository)
...
[![Mutation testing cover][badge-mutation]](https://stryker-mutator.github.io)
[![Inline docs][badge-inch]](http://inch-ci.org/github/tiagoporto/reference-repository)
...
[badge-changelog]:https://img.shields.io/badge/-changelog-grey.svg?style=flat-square
[badge-release]:https://img.shields.io/npm/v/reference-repository.svg?style=flat-square&label=release
